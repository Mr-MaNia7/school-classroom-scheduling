...
from genetic_algorithm import genetical_sort2
...
KH = Subject(Subject_name="Kemahiran Hidup",
             period_number=3, specialty_required=False)
Pendidikan_Seni = Subject(Subject_name="Pendidikan Seni",
                          period_number=3, specialty_required=False)

PJK_lower = Subject(Subject_name="PJK_lower", period_number=3,
                    morning=True, specialty_required=False)
PJK_upper = Subject(Subject_name="PJK_upper", period_number=2,
                    morning=True, specialty_required=False)

Lower_form_subject = [Maths, Science, English, Malay, Chinese,
                      Moral, Sejarah, Geografi, KH, Pendidikan_Seni, PJK_lower]
Upper_form_subject = [Maths, Add_Maths, English, Malay, Chinese,
                      Moral, Sejarah, PJK_upper, Biology, Chemistry, Physics]
...
Geografi_teacher_A = Teacher(
    subject=Geografi, teacher_name="Geografi_teacher_A")
...
Chemistry_teacher_A = Teacher(
    subject=Chemistry, teacher_name="Chemistry_teacher_A")
...
Add_maths_teacher_A = Teacher(
    subject=Add_Maths, teacher_name="Add_maths_teacher_A")
...
genetic_instance = genetical_sort2(class_instances=Classroom.instances, subject_instances=Subject.instances,
